...
namespace Engine {
	namespace Test {
		bool TestPointers() {
			Actor* testActor1 = new Actor("test1", Vector2D::ZERO);
			...
			Pointer::SmartPointer<Actor> smartTest4(new Actor("test4", Vector2D::ZERO));
			assert(smartTest4);
			...
			assert(smartTest4.getCounter()->weakCount == 0);
			Actor* testActor2 = new Actor("test", Vector2D::ZERO);
